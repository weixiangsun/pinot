...
public class QueryContextUtils {
  ...
  public static boolean isSelectionOnlyQuery(QueryContext query) {
    return query.getAggregationFunctions() == null && query.getOrderByExpressions() == null && !GapfillUtils.isPreAggregateGapfill(query);
  }
  ...
  public static boolean isAggregationQuery(QueryContext query) {
    ...
    return !GapfillUtils.isPreAggregateGapfill(query) && (aggregationFunctions != null && (aggregationFunctions.length != 1
